...
class VideoGenerator:
    ...
    def _inference(self, inp: str, out: str):
        ...
        # [img.path for img in os.scandir(inp) if img.name.endswith(".jpg") or img.name.endswith(".png")]
        
        # for img_path in tqdm(sorted(glob.glob(os.path.join(inp, "*.jpg")))):
        for img_path in tqdm(sorted([img.path for img in os.scandir(inp) if img.name.endswith(".jpg") or img.name.endswith(".png")])):
